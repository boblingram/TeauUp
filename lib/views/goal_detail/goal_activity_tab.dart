  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: isEditingEnabled
          ...
          : null,
      body: GetBuilder<VEGoalController>(
        builder: (veGoalController) {
          switch (veGoalController.goalActivityNetworkEnum) {
            case NetworkCallEnum.Completed:
              return veGoalController.selectedGoalActivityList.isNotEmpty
                  ? RefreshIndicator(
                      onRefresh: () async {
                      ...
                      child: ListView.builder(
                          ...
                          itemCount: veGoalController
                              .selectedGoalActivityList.length,
                          physics: const NeverScrollableScrollPhysics(),
                          shrinkWrap: true,
                          itemBuilder: (BuildContext context, int index) {
                            var item = veGoalController
                                .selectedGoalActivityList
                                .elementAt(index);
                            return Column(
                              children: [
                                Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      veGoalController
                                              .showReminderDate(item.reminder)
                                          ? const Text.rich(
                                              TextSpan(
                                                children: [
                                                  TextSpan(
                  ...
                  : ListErrorWidget(text: "Goal Activity List is Empty");
            case NetworkCallEnum.Error:
              return ListErrorWidget(
                  text: "Failed to retrieve goal activities data.");

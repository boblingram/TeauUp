...
class CustomExpansionTile extends StatefulWidget {
  ...
  const CustomExpansionTile(
      {Key? key,
        ...
        this.trailing2,
        this.tapChildrenBoxDecoration,
        this.mainTitleDecoration,
        this.mainTitlePadding,
      })
  ...
  ///Box Decoration when tap on tile
  final BoxDecoration? tapChildrenBoxDecoration;

  final BoxDecoration? mainTitleDecoration;
  final EdgeInsets? mainTitlePadding;
...
class _CustomExpansionTileState extends State<CustomExpansionTile>
  ...
  Widget? _buildTIcon(BuildContext context) {
    return RotationTransition(
      turns: _iconTurns,
  ...
  Widget _buildChildren(BuildContext context, Widget? child) {
    ...
    return Container(
      decoration: widget.tapChildrenBoxDecoration ??  BoxDecoration(
      ...
      child: Column(
        ...
        children: <Widget>[
          ListTileTheme.merge(
            ...
            child: Container(
              padding: widget.mainTitlePadding ?? EdgeInsets.zero,
              decoration: widget.mainTitleDecoration ?? BoxDecoration(),
              child: ListTile(
                onTap: _handleTap,
                ...
                trailing: _isExpanded
                    ? widget.trailing
                    : widget.trailing2 ?? _buildTrailingIcon(context),
              ),
            ),
          ),
          ClipRect(
